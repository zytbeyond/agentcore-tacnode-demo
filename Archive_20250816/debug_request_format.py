#!/usr/bin/env python3
"""
Debug the exact request format needed for the gateway
"""
...
async def debug_request_format():
    """Debug what exact format the gateway expects"""
    print("🔧 DEBUGGING REQUEST FORMAT")
    print("=" * 60)
    ...
    tool_name = "final-working-tacnode-target___executeQuery"
    ...
    # Test 1: Direct SQL in arguments
    print(f"\n📋 TEST 1: Direct SQL in arguments")
    test1_request = {
        "jsonrpc": "2.0",
        "id": 1,
    ...
    # Test 2: Minimal JSON-RPC structure
    print(f"\n📋 TEST 2: Minimal JSON-RPC structure")
    test2_request = {
        "jsonrpc": "2.0",
        "id": 1,
    ...
    # Test 3: Check what the working direct call looks like
    print(f"\n📋 TEST 3: Working direct call format (for comparison)")
...
if __name__ == "__main__":
    asyncio.run(debug_request_format())
